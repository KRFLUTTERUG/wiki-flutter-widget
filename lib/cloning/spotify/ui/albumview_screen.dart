...
import '../data/model/album_track.dart';
import '../widgets/bottom_player.dart';
import '../widgets/stream_button.dart';
import 'album_control_screen.dart';
                            ...
                            Padding(
                              ...
                              child: Opacity(
                                ...
                                child: Container(
                                  ...
                                  child: Image.asset(
                                    'images/cloning/spotify/home/${state.album.albumImage}',
                                  ),
                                ),
                              ),
                            ),
          ...
          Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Image.asset(
                    'images/cloning/spotify/icon_downloaded.png',
                    height: 13,
                    width: 13,
                  ),
                  const SizedBox(
            ...
            Row(
              children: [
                CircleAvatar(
                  radius: 15,
                  backgroundImage:
                  AssetImage('images/cloning/spotify/artists/${widget.album.artistImage}'),
                ),
                const SizedBox(
                  width: 8,
                ),
              ...
              child: Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Image.asset('images/cloning/spotify/icon_more.png'),
                  ),
                ],
              ),
            ),

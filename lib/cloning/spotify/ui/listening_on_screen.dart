            ...
            child: Column(
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: Image.asset("images/cloning/spotify/icon_back.png"),
                ),
                Padding(
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Image.asset('images/cloning/spotify/icon_bluetooth.png'),
                              const SizedBox(
                                width: 5,
                              ),
                              const Text(
                    ...
                    Row(
                      children: [
                        ...
                        Stack(
                          ...
                          children: [
                            Image.asset('images/cloning/spotify/icon_beta.png'),
                            const Text(
                              "BETA",
                              style: TextStyle(
                                fontFamily: "AB",
                ...
                Row(
                  children: [
                    Image.asset('images/cloning/spotify/icon_audio.png'),
                    SliderTheme(
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Row(
          children: [
            Image.asset('images/cloning/spotify/icon_monitor.png'),
            const SizedBox(width: 15),
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                ...
                Row(
                  children: [
                    Image.asset('images/cloning/spotify/icon_cast.png'),
        ...
        Row(
          ...
          children: [
            Row(
              children: [
                Image.asset('images/cloning/spotify/icon_tv.png'),
                const SizedBox(width: 15),
                const Text(
            ...
            Image.asset('images/cloning/spotify/icon_more.png'),
          ],
        ),
        const SizedBox(
          height: 30,
        ...
        Row(
          children: [
            Image.asset('images/cloning/spotify/icon_airplay.png'),

...
import 'package:wiki_flutter_examples/cloning/spotify/ui/profile_screen.dart';
...
import '../widgets/album_chip.dart';
                      ...
                      child: Row(
                        ...
                        children: [
                            ...
                            child: const Row(
                              ...
                              children: [
                                CircleAvatar(
                                  radius: 20,
                                  backgroundImage:
                                  AssetImage("images/cloning/spotify/myImage.png"),
                                ),
                                SizedBox(width: 10),
                                Text(
                                  "Your Library",
                          ...
                          GestureDetector(
                            ...
                            child: Image.asset("images/cloning/spotify/icon_add.png"),
                          ),
                        ],
                      ),
                    ),
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Row(
                            children: [
                              Row(
                                children: [
                                  Image.asset(
                                    "images/cloning/spotify/arrow_component_down.png",
                                    width: 10,
                                    height: 12,
                                  ),
                                  Image.asset(
                                    "images/cloning/spotify/arrow_component_up.png",
                                    width: 10,
                                    height: 12,
                                  ),
                                ],
                          ...
                          Image.asset("images/cloning/spotify/icon_category.png"),
                        ],
                      ),
                    ),
                  ),
        ...
        child: Row(
          children: [
            Stack(
              ...
              children: [
                Image.asset("images/cloning/spotify/new_episods.png"),
                Image.asset("images/cloning/spotify/icon_bell_fill.png"),
              ],
            ),
            const SizedBox(
              width: 10,
            ...
            Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Image.asset("images/cloning/spotify/icon_pin.png"),
        ...
        child: Row(
          children: [
            Stack(
              alignment: AlignmentDirectional.center,
              children: [
                Image.asset("images/cloning/spotify/liked_songs.png"),
                Image.asset("images/cloning/spotify/icon_heart_white.png"),
              ],
            ),
            const SizedBox(
              width: 10,

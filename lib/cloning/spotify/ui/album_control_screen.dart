...
import 'package:wiki_flutter_examples/cloning/spotify/ui/share_song_screen.dart';
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          Image.asset("images/cloning/spotify/$image"),
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Image.asset(
          "images/cloning/spotify/home/${album.albumImage}",
          height: 164,
          width: 164,
        ),
        const SizedBox(

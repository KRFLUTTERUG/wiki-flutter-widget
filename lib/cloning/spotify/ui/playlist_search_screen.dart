                  ...
                  Row(
                    children: [
                      SizedBox(
                        ...
                        width: 48,
                        child: Image.asset(
                            'images/cloning/spotify/${state.playlist.tracks[index].image}'),
                      ),
        ...
        children: [
          Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Image.asset('images/cloning/spotify/icon_spotify.png'),
                  const SizedBox(width: 5),
                  const Text(
                    "Spotify",
                    style: TextStyle(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      child: (_isDownloaded)
                          ? Image.asset('images/cloning/spotify/icon_downloaded.png')
                          : Image.asset('images/cloning/spotify/icon_download.png'),
                    ),
                    Image.asset('images/cloning/spotify/icon_more.png'),
                  ],
                ),
    ...
    return SliverToBoxAdapter(
      child: Column(
        ...
        children: [
          ...
          Center(
            child: Image.asset(
              'images/cloning/spotify/home/$cover',
              height: 270,
              width: 270,
            ),
          ),
          ...
          Container(
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  Image.asset(
                    "images/cloning/spotify/icon_search_transparent.png",
                    color: MyColors.whiteColor,
                  ),
                  const Expanded(
                    child: TextField(

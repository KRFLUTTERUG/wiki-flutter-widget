      ...
      child: Row(
        ...
        children: [
          GestureDetector(
            ...
            child: (isInShuffle)
                ? Image.asset(
              'images/cloning/spotify/icon_shuffle_on.png',
              height: 22,
              width: 22,
            )
                : Image.asset(
              'images/cloning/spotify/icon_shuffle_off.png',
              height: 22,
              width: 22,
            ),
          ),
          Image.asset('images/cloning/spotify/icon_back_song.png'),
          GestureDetector(
            onTap: () {
              setState(() {
                isInPlay = !isInPlay;
          ...
          Image.asset('images/cloning/spotify/icon_next_song.png'),
          GestureDetector(
            onTap: () {
              setState(() {
            ...
            child: (isInRepeat)
                ? Image.asset(
              'images/cloning/spotify/icon_repeat_on.png',
              height: 29,
              width: 29,
            )
                : Image.asset(
              'images/cloning/spotify/icon_restart_off.png',
              height: 29,
              width: 29,
            ),
          ),
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Image.asset(
                        'images/cloning/spotify/icon_move.png',
                      ),
                    ],
                  ),
                ),
          ...
          children: [
            GestureDetector(
              ...
              child: Container(
                ...
                child: Center(
                  child: Image.asset(
                    "images/cloning/spotify/icon_back.png",
                    height: 16,
                    width: 16,
                  ),
                ),
        ...
        Row(
          children: [
            SizedBox(
              height: 46,
              width: 46,
              child: Image.asset('images/cloning/spotify/home/AUSTIN.jpg'),
            ),
            const SizedBox(
              width: 10,
            ),

          ...
          children: [
            GestureDetector(
              ...
              child: Container(
                ...
                child: Center(
                  child: Image.asset(
                    "images/cloning/spotify/icon_arrow_left.png",
                    height: 16,
                    width: 16,
                  ),
                ),
      ...
      child: Padding(
        ...
        child: Container(
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                Image.asset("images/cloning/spotify/icon_Search.png"),
                const Expanded(
                  child: TextField(
                    style: TextStyle(
                      fontFamily: "AM",

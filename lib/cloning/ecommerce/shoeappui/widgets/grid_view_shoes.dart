...
import 'package:wiki_flutter_examples/cloning/ecommerce/shoeappui/widgets/shoe_details.dart';
...
class _GridViewShoesState extends State<GridViewShoes> {
  ...
  List fileNames = [
    ...
    "assets/shoeappui/files/myshoes_basketball.json",
    "assets/shoeappui/files/myshoes.json",
